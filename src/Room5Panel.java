...
// Resize the icon if necessary
    ...
    /* private void startTimer() {
        timeLeft = 15; // Reset the time left for the new question
        timerLabel.setText("Time left: " + timeLeft); // Update timer label
        ...
        questionTimer = new Timer(1000, e -> {
            ...
            if (timeLeft <= 0) {
                ...
                if (lives <= 0) {
                    ...
                    displayQuestion(); // Move to the next question or repeat the current
                }
            }
        });
        questionTimer.start();
